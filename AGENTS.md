...
- Evangelievers med omkved–vers–omkved bruker `{ "type": "acclamation", "response": "Allelúia.", "lines": ["Herre, gjør våre hjerter åpne", "for din Sønns ord."] }`. Importeren legger til ℟/℣ og gjentar omkvedet; nettsiden viser hele blokken sentrert i fet kursiv. Bruk kildens faktiske omkved, også utenfor alleluia-tiden. Utelat `response` når kilden ikke har omkved. Andre strukturer gjengis med vanlig Portable Text; ikke press dem inn i dette mønsteret.
